...
const ModalContent: FC = () => {
  ...
  const updateDuration = () => {
    ...
    put(`/admin/domain/manage/${modalData?.id}/update-dates`, payload)
      .then((res) => {
...
const ModalUpdateDomainDates = () => {
  const { closeModal, modalType } = useTemplate();
  return (
    <Dialog
      open={modalType === "update-domain-dates"}
...
export default ModalUpdateDomainDates;
