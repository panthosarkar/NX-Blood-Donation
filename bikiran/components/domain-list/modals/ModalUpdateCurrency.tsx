...
const ModalContent: FC = () => {
  ...
  const { currencies, reload, domainListData } = useDomainList();
  const { put } = useApi();
  ...
  const handleUpdateCurrency = () => {
    setLoading(true);
    put(`/admin/domain/manage/${modalData?.id}/update-currency`, formData)
      .then((res) => {
...
const ModalUpdateCurrency = () => {
  ...
  return (
    <Dialog
      open={modalType === "domain-currency-update"}
