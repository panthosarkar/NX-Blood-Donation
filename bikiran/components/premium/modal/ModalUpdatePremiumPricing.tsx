...
const ModalContent: FC = () => {
  ...
  //     }));
  //   }
  // }, [formData.contractPrice, formData.contractCurrency]);
  ...
  //     }));
  //     return formData.contractPriceOffer * formData.contractCurrencyRate;
  //   }
  //   setFormData((prev) => ({
  //     ...prev,
  //     contractPrice: formData.contractPrice,
  //   }));
  //   return formData.contractPriceOffer;
  // }, [
  //   formData.contractPrice,
  //   formData.contractCurrencyRate,
  //   formData.contractPriceOffer,
  // ]);
  ...
  const handleSubmit = () => {
    ...
    post(`/admin/premium-contract/${modalData?.id}/update-pricing`, payload)
      .then((res) => {
...
export default ModalUpdatePremiumPricing;
