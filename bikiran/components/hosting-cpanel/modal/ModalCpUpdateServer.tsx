...
const ModalContent: FC = () => {
  ...
  const updateServer = () => {
    ...
    put(`/admin/hosting/cp-manage/${modalData?.id}/fix-server`, formData)
      .then((res) => {
  ...
  return (
    <div className="space-y-3">
      ...
      <AnimatedSelect
        ...
        label={""}
        name="newHostname"
        placeholder="Select New Hostname"
...
const ModalCpUpdateServer = () => {
  const { closeModal, modalType, modalData } = useTemplate();
  return (
    <Dialog open={modalType === "cp-update-server"} onOpenChange={closeModal}>
...
export default ModalCpUpdateServer;
