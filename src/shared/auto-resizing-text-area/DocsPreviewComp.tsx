...
import { icons, supportInfoIcons } from "@/src/lib/icons";
...
const DocsPreviewComp: React.FC<DocsPreviewProps> = ({
  previews,
  files,
    ...
    <div className="flex flex-wrap gap-4">
      {files.map((file, index) => (
        <div key={index} className={cn("relative mt-2", className)}>
          ...
          previews[index]?.startsWith("data:image/") ? (
            <div>
              <Image
              ...
              >
                <Image
                  src={supportInfoIcons.iconCloseWhite}
                  width={0}
                  height={0}
                  alt="closeIcon"
                />
            ...
            previews[index] === supportInfoIcons.iconPdf && (
              <div className="flex items-center justify-center h-full">
                ...
                >
                  <Image
                    src={supportInfoIcons.iconCloseHover}
                    width={0}
                    height={0}
                    alt="closeIcon"
                  />
