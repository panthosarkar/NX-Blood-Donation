...
import DocsPreviewComp from "@/src/shared/auto-resizing-text-area/DocsPreviewComp";
...
const AutoResizingTextarea: FC<AutoResizingTextareaProps> = ({
  ...
  const updatePreviewHeight = () => {
    ...
    const filesPerLine = textareaRef.current
      ? Math.floor(textareaRef.current.clientWidth / 50) || 1
      : 1; // Assuming each file preview takes 50px width
